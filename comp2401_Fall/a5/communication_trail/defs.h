...
// define the character with contant value
#define TIMMY 'T'
#define HAROLD 'H'
#define BIRD 'v'
#define MONKEY '@'
...
//extra defined function

// hero.c
//
//for init the hero array type
void initHeroArray(HeroArrayType* Array);//
//for the probality finding;
int ProbableOutcome(int *arr, int len);
